...
const Translator = () => {
  ...
  const fetchPartsOfSpeech = async (translated) => {
    try {
      const response = await axios.post('https://mini-project-nka2htdww-abhinay2025s-projects.vercel.app/pos', { text: translated });
  ...
  const translateKeywords = async () => {
    ...
    try {
      const response = await axios.post('https://mini-project-nka2htdww-abhinay2025s-projects.vercel.app/translate_keywords', { text: [inputText] });
